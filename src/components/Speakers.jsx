    ...
    >
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2
            id="speakers-title"
            className="font-display text-4xl font-medium tracking-tighter text-indigo-400 sm:text-5xl"
          >
            Speakers
          </h2>
          <p className="mt-4 font-display text-2xl tracking-tight text-indigo-100">
        ...
        >
          <div className="relative -mx-4 flex overflow-x-auto pb-4 sm:mx-0 sm:block sm:overflow-visible sm:pb-0">
            <div className="absolute top-2 bottom-0 left-0.5 hidden w-px bg-slate-700 lg:block" />
                    ...
                    <div key={day.dateTime} className="relative lg:pl-8">
                      ...
                      <div className="relative">
                        ...
                        <time
                          ...
                          className="mt-1.5 block text-2xl font-semibold tracking-tight text-indigo-100"
                        >
                          {day.date}
                        </time>
                      </div>
              ...
              >
                {day.speakers.map((speaker, speakerIndex) => (
                  <div key={speakerIndex}>
                    ...
                    <h3 className="mt-8 font-display text-xl font-bold tracking-tight text-slate-100">
                      {speaker.name}
                    </h3>
